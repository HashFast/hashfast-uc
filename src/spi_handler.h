...
// You can this in bits 'n pieces, but the FIFO that contains it will only
// be flushed if you read the last word - vadc_status - so we simply set up
// a DMA controller and periodically read the lot.
